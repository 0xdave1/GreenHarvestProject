      ...
      <div className="container  mx-auto px-4 py-12">
              ...
              <div className="flex flex-col md:flex-row items-center gap-12">
                <div className="md:w-1/2 text-center md:text-left">
                  ...
                  <p className="text-gray-800 text-lg mb-4">
                    GreenHarvest was founded with a simple yet powerful mission:
        ...
        <section className="mb-32">
          ...
          <p className="text-center text-gray-600 text-xl mb-16">
            Passionate people behind GreenHarvest
          </p>
        ...
        <section className="text-center mb-8">
          ...
          <p className="text-xl text-gray-500 max-w-3xl mx-auto mb-8">
            ...
            consumer seeking fresh, local produce, GreenHarvest is for you.
          </p>
